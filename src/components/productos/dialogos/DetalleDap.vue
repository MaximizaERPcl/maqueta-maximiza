      ...
      <v-card tile flat>
        <v-toolbar color="primary" dark flat tile>
          <v-toolbar-title class="flex text-center titulo"
            >Deposito a plazo N° {{ dialog.data.n_cuenta }}</v-toolbar-title
          >
        </v-toolbar>
        <v-card-title>
        ...
        <v-row no-gutters>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-subtitle
                  >Descripción del producto</v-list-item-subtitle
                >
                <v-list-item-title>{{
          ...
          <v-col cols="12" sm="12" md="6">
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-subtitle
                  >Descripción tipo de renovación</v-list-item-subtitle
                >
                <v-list-item-title>{{
                  dialog.data.desc_estado
                }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-divider></v-divider>
          ...
          <v-col cols="12" sm="12" md="6">
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-title>{{
                  conv.formatDias(dialog.data.daple_n_dia_plazo)
                }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-divider></v-divider>
          ...
          <v-col cols="12" sm="12" md="6">
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-title>{{
                  conv.formatPorcentaje(dialog.data.tasa_base)
                }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-divider></v-divider>
          ...
          <v-col cols="12" sm="12" md="6">
            <v-list-item>
              <v-list-item-icon>
                <v-icon color="primary"> mdi-lock-alert </v-icon>
              </v-list-item-icon>
          ...
          <v-col cols="12" sm="12" md="6">
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-title>{{
                  conv.formatMonto(dialog.data.monto_inicial, true)
                }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-divider></v-divider>
          ...
          <v-col cols="12" sm="12" md="6">
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-subtitle
                  >Monto interés pactado</v-list-item-subtitle
                >
                <v-list-item-title>{{
                  conv.formatMonto(dialog.data.monto_interes, true)
                }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-divider></v-divider>
          ...
          <v-col cols="12" sm="12" md="6">
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-title>{{
                  conv.formatMonto(dialog.data.monto_final, true)
                }}</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-divider></v-divider>
        ...
        >
          ...
          <template v-slot:item.t_interes_r="{ item }">
            {{ conv.formatPorcentaje(item.t_interes_r) }}
          </template>

          <template v-slot:item.m_int_pactado="{ item }">
            ${{ item.m_int_pactado }}
          </template>

          <template v-slot:item.v_renovacion="{ item }">
            ${{ item.v_renovacion }}
          </template>
        </v-data-table>
  ...
  methods: {
    ...
    exportPDF() {
      pdf.exportToPdfDAP(
        ...
        this.detalles,
        this.dialog,
        "Depósito a plazo N°" + this.dialog.data.n_cuenta
      );
    },
  },
  mounted() {
