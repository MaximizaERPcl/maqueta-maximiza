<template>
  <v-container>
    <v-row justify="center">
      <v-col cols="10">
        <v-alert text outlined class="text-center mb-8 alerta">
          Recuerde que solo se permiten <b>números</b> y su clave debe tener
          <b>6 dígitos</b>.
        </v-alert>
      </v-col>
    </v-row>
    <v-form class="mt-5" ref="form" v-model="valid">
      <v-row justify="center" no-gutters>
          ...
          <v-text-field
            ...
            :rules="[
              ...
              (v) =>
                ...
                'La clave solo debe contener dígitos',
            ]"
        ...
        <v-col cols="12" sm="10" md="8">
          <v-text-field
            ...
            :rules="[
              (v) => !!v || 'Campo requerido',
              (v) =>
                v === form.clave_nueva || 'Las claves ingresadas no coinciden',
            ]"
        ...
        <v-col cols="12" sm="10" md="8" class="d-flex justify-end">
          <v-btn color="primary" large :loading="loading" @click="validate()">
