  ...
  <v-container fill-height fluid>
    <v-container fill-height fluid>
      <v-row align="center" justify="center">
        <v-col cols="12" sm="10" md="6" class="glass px-0">
          <v-card class="pb-6" color="transparent" outlined>
            <v-tabs
...
import LoginVue from "@/components/login/LoginUser.vue";
